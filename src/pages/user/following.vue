...
const followingUsers = ref([
  ...
  { id: 4, name: 'DB技术专', color: '#9c27b0', newCount: 0 },
...
const articles = ref([
  {
    ...
    desc: '本文系统解析了CPU调度机制，分析其必要性、核心目标和经典算法。CPU调度通过时间分片和优先级排序实现多任务并�?..',
  ...
  },
  {
    ...
    title: '2026年Java面试最新高频题汇总：Spring、JVM、并发一网打',
    desc: '整理�?026年最新Java面试高频考点，涵盖Spring框架原理、JVM调优、多线程并发、分布式系统设计等核心模�?..',
    category: 'Java', publishTime: '2026-02-23 11:00',
    readCount: '3.2k', likeCount: 156, commentCount: 42,
    cover: 'https://placehold.co/160x100/ff4d4f/FFFFFF?text=Java', isNew: true
  },
  {
    id: 6, authorId: 3, author: 'RR1335', authorColor: '#faad14',
    title: 'WebAssembly 2026：前端性能革命的下一�',
    desc: 'WebAssembly正在改变前端开发的边界，本文探讨WASM�?026年的最新进展、应用场景以及与JavaScript的协作模�?..',
  ...
  },
  {
    ...
    cover: 'https://placehold.co/160x100/9c27b0/FFFFFF?text=Rust', isNew: true
  },
  // 一周前的文章（不显�?NEW�?
  {
    id: 8, authorId: 4, author: 'DB技术专', authorColor: '#9c27b0',
    title: 'MySQL 8.0 新特性深度解',
    ...
    cover: 'https://placehold.co/160x100/FF6600/FFFFFF?text=MySQL', isNew: false
  }
])
