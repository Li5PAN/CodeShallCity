...
const demandMap = {
  1: {
    ...
    budgetMax: 5000,
    description:
      "需要基于MiniMax大模型开发一套智能客服系统，支持多轮对话、意图识别、知识库接入",
    type: "人工智能",
    urgency: "紧急",
    views: 1256,
    bids: 12,
  ...
  2: {
    ...
    budgetMax: 15000,
    description:
      "开发一款电商类App，需要支持iOS和Android双端，包含商品浏览、购物车、支付功能",
    type: "移动开发",
    urgency: "一般",
    views: 892,
    bids: 7,
  ...
  3: {
    ...
    budgetMax: 2500,
    description:
      "现有系统查询慢，需要专业DBA对数据库进行诊断和优化，提供优化报告",
    type: "数据库",
    urgency: "一般",
    views: 654,
    bids: 5,
  ...
  4: {
    ...
    budgetMax: 10000,
    description:
      "基于Vue3+Element Plus开发一套通用后台管理系统，包含权限管理、数据可视化",
    type: "Vue/React",
    urgency: "紧急",
    views: 1023,
    bids: 9,
